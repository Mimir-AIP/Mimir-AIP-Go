    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <button
            onClick={loadMetrics}
            className="flex items-center gap-2 px-4 py-2 bg-blue text-white rounded hover:bg-blue/80 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-orange text-navy rounded hover:bg-orange/90 transition-colors"
          >
