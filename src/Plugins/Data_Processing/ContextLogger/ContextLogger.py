"""
Diagnostic plugin to log context keys and values after any pipeline step.
"""
...
class ContextLogger(BasePlugin):
    ...
    def execute_pipeline_step(self, step_config, context):
        ...
        print(f"[ContextLogger PRINT] Context keys: {list(context.keys())}")
        if log_values:
            ...
            print(f"[ContextLogger PRINT] Context values: {json.dumps(safe_context, indent=2)}")
            ...
            for key in ["traffic_image_path", "image_base64"]:
                ...
                if value is not None:
                    ...
                    print(f"[ContextLogger PRINT] Explicit {key}: {value}")
        return {}
